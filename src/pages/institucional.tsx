...
const Institutional: React.FC = () => {
  const goToWpp = () => {
    ...
    a.href = `${baseUrl}${phoneNumber}${queryParams}`;
    a.target = '_blank';
    a.click();
  };
    ...
    <>
      ...
      <main className={styles.main}>
        <div className={styles.container}>
          ...
          <div className={styles.container__content}>
            ...
            <div className={styles.container__text}>
              <p>
                A ideia da Zenite Clean iniciamente surgiu a 3 anos atrás em
                2017 quando o fundador da empresa, Valmir Ferraz, identificou a
              ...
              <p>
                ...
                aprofundar nesse conceito de limpeza e como seria feito de novo
                no mercado.
              </p>
              <p>
                ...
                médico anestesista nesse projeto completando com sua visão na
                área clínica e tecnologia na hora de executar uma limpeza
                profunda.
              </p>
            </div>
          </div>
        ...
        <div className={styles.floatingButton}>
          <button type="button" onClick={goToWpp}>
